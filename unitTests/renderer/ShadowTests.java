...
public class ShadowTests {
    ...
    private Camera camera = new Camera(
            ...
            .setVPSize(200, 200)
            .setVPDistance(1000)                                                                       //
            .setRayTracer(new RayTracerBasic(scene).setNumOfRays(3000));
    ...
    public void sphereTriangleMove1() {
        sphereTriangleHelper("shadowSphereTriangleMove1-softShadow-size30-3000rays", //
    ...
    public void trianglesSphere() {
        ...
        scene2.lights.add( //
                new SpotLight(new Color(700, 400, 400), new Point(40, 40, 115), new Vector(-1, -1, -4)) //
                        .setKl(4E-4).setKq(2E-5).setSize(0));
